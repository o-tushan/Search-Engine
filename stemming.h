...
namespace stemming
{
    ...
    [[nodiscard]] inline constexpr wchar_t full_width_to_narrow(const wchar_t ch) noexcept
    {
        return
            ...
            (ch < 65'000) ? ch : (ch >= 65'281 && ch <= 65'374) ? (ch - 65'248)
                                                                :
    ...
    */
    ...
    public:
        ...
        [[nodiscard]] virtual stemming_type get_language() const noexcept = 0;
        /// Destructor.
        virtual ~stem() {}
    ...
    protected:
        ...
        [[nodiscard]] constexpr bool is_apostrophe(const wchar_t &ch) const noexcept
        {
            return (ch == 39) ? // '
                       true
                              : (ch == 146) ? // apostrophe
        ...
        [[nodiscard]] inline static bool is_suffix(const string_typeT &text,
        ...
        [[nodiscard]] inline static bool is_partial_suffix(const string_typeT &text,
        ...
        [[nodiscard]] inline bool is_suffix_in_rv(const string_typeT &text,
                                                  const wchar_t suffix1L, const wchar_t suffix1U) noexcept
        {
            if (text.length() < 1)
            {
        ...
        [[nodiscard]] inline bool is_suffix_in_r1(const string_typeT &text,
                                                  const wchar_t suffix1L, const wchar_t suffix1U) noexcept
        {
            if (text.length() < 1)
            {
        ...
        [[nodiscard]] inline bool is_suffix_in_r2(const string_typeT &text,
                                                  const wchar_t suffix1L, const wchar_t suffix1U) noexcept
        {
            if (text.length() < 1)
            {
        ...
        /// @param suffix6U The uppercased version of the sixth character of the suffix.
        /// @returns @c true if suffix is in R2.
        [[nodiscard]] inline bool is_suffix_in_r2(string_typeT &text,
                                                  const wchar_t suffix1L, const wchar_t suffix1U,
                                                  const wchar_t suffix2L, const wchar_t suffix2U,
                                                  const wchar_t suffix3L, const wchar_t suffix3U,
                                                  const wchar_t suffix4L, const wchar_t suffix4U,
        ...
        void italian_acutes_to_graves(string_typeT &text) noexcept
        {
            std::transform(text.cbegin(), text.cend(), text.begin(),
                           ...
                           {
                               return (ch == common_lang_constants::UPPER_A_ACUTE) ? common_lang_constants::UPPER_A_GRAVE : (ch == common_lang_constants::UPPER_E_ACUTE) ? common_lang_constants::UPPER_E_GRAVE
                                                                                                                        : (ch == common_lang_constants::UPPER_I_ACUTE)   ? common_lang_constants::UPPER_I_GRAVE
                                                                                                                        : (ch == common_lang_constants::UPPER_O_ACUTE)   ? common_lang_constants::UPPER_O_GRAVE
                                                                                                                        : (ch == common_lang_constants::UPPER_U_ACUTE)   ? 0xD9
                                                                                                                        : (ch == common_lang_constants::LOWER_A_ACUTE)   ? common_lang_constants::LOWER_A_GRAVE
                                                                                                                        : (ch == common_lang_constants::LOWER_E_ACUTE)   ? common_lang_constants::LOWER_E_GRAVE
                                                                                                                        : (ch == common_lang_constants::LOWER_I_ACUTE)   ? common_lang_constants::LOWER_I_GRAVE
                                                                                                                        : (ch == common_lang_constants::LOWER_O_ACUTE)   ? common_lang_constants::LOWER_O_GRAVE
                                                                                                                        : (ch == common_lang_constants::LOWER_U_ACUTE)   ? 0xF9
                                                                                                                                                                         : ch;
                           });
        }
        ...
        inline void unhash_dutch_yi(string_typeT &text)
        {
            std::transform(text.cbegin(), text.cend(), text.begin(),
                           [](const auto &ch) noexcept
                           {
                               return (ch == LOWER_Y_HASH) ? common_lang_constants::LOWER_Y : (ch == UPPER_Y_HASH) ? common_lang_constants::UPPER_Y
                                                                                          : (ch == LOWER_I_HASH)   ? common_lang_constants::LOWER_I
                                                                                          : (ch == UPPER_I_HASH)   ? common_lang_constants::UPPER_I
                                                                                                                   : ch;
                           });
        }
        ...
        inline void unhash_german_yu(string_typeT &text)
        {
            std::transform(text.cbegin(), text.cend(), text.begin(),
                           ...
                           {
                               return (ch == LOWER_Y_HASH) ? common_lang_constants::LOWER_Y : (ch == UPPER_Y_HASH) ? common_lang_constants::UPPER_Y
                                                                                          : (ch == LOWER_U_HASH)   ? common_lang_constants::LOWER_U
                                                                                          : (ch == UPPER_U_HASH)   ? common_lang_constants::UPPER_U
                                                                                                                   : ch;
                           });
        }
        ...
        inline void unhash_italian_ui(string_typeT &text) noexcept
        {
            std::transform(text.cbegin(), text.cend(), text.begin(),
                           [](const auto &ch) noexcept
                           {
                               return (ch == LOWER_I_HASH) ? common_lang_constants::LOWER_I : (ch == UPPER_I_HASH) ? common_lang_constants::UPPER_I
                                                                                          : (ch == LOWER_U_HASH)   ? common_lang_constants::LOWER_U
                                                                                          : (ch == UPPER_U_HASH)   ? common_lang_constants::UPPER_U
                                                                                                                   : ch;
                           });
        ...
        [[nodiscard]] inline static constexpr wchar_t is_western_letter(const wchar_t ch) noexcept
        {
            return (
                // A-Z
                (ch >= 0x41 && ch <= 0x5A) ||
        ...
        [[nodiscard]] inline static constexpr bool is_one_of(const wchar_t character,
    ...
    public:
        ...
        /// @returns The stemmer's language.
        [[nodiscard]] stemming_type get_language() const noexcept final
        {
